...
pub use grep::{
    ...
    CompiledQuery, Error as GrepError, Input, Inputs, Match, MatchOptions, Matcher, Query, Report,
    Session, Stats, StatsMode, GlobConfig, HiddenMode, IgnoreConfig, IgnoreSources,
