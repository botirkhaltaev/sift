...
pub use options::{BinaryMode, CaseMode, InputEncoding, SearchMatchFlags, SearchOptions};
...
pub use request::{LinkTraversal, SearchCollection, StreamInput, WalkOptions};
