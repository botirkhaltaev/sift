...
| [`lexicon.rs`](lexicon.rs) | `LexiconEntry`, `write_lexicon`, `MappedLexicon` — sorted trigram → postings slice descriptor |
| [`postings.rs`](postings.rs) | `write_postings`, `MappedPostings` — contiguous `u32` LE file-ID payloads |
