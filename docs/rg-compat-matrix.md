...
| `--stats` | `ripgrep/crates/printer/stats.rs` (approx.) | Partial | Match tally, files searched, sum of file sizes (bytes searched), elapsed on stderr; parity vs rg totals not guaranteed. |
